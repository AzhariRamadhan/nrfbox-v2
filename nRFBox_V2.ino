...
void about() {
  ...
  u8g2.drawStr(7, 15, "azhari.ramadhan0902@gmail.com");
  u8g2.drawStr(12, 35, "GitHub/AzhariRamadhan");
  u8g2.drawStr(7, 55, "instagram/ary.ramadhanz");
  u8g2.sendBuffer();
}
...
void setup() {
  ...
  u8g2.print("Skill-issue");
  
  u8g2.setFont(u8g2_font_ncenB08_tr); 
  u8g2.setCursor(15, 50); 
  u8g2.print("by Azhari");
